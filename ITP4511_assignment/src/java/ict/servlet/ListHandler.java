            ...
            for (ProductBean i : allProduct){
                if (count % 4 == 0){
                    responseData +="<div class='row-fluid'>"
                                               ...
                                               +"<li class='span3'>"
                                               +"<div class='thumbnail'>"
                                               +"<img alt='300x200' src='img/product/" + i.getPicturePath()+ "'>"
                                               +"<div class='caption'>"
                                               +"<h3>" + i.getP_name() + "</h3>"
                                               +"<p>" + i.getDescriptions() + "</p>"
                                               +"<p><a href='checkout?id=" + i.getP_id() + "'class='btn btn-primary'>Add To Cart</a>&nbsp;<a href='view?id=" + i.getP_id() +"' class='btn'>View</a></p>" 
                                               +"</div>"
                                               +"</div>"
                                               +"</li>";
                }else{
