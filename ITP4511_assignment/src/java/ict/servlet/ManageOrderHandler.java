 ...
 * @author EVANFUNG
 */
@WebServlet(name = "ManageOrderHandler", urlPatterns = {"/ManageOrderHandler"})
public class ManageOrderHandler extends HttpServlet {
    private OrderDB odb;
    public void init() {
...
//        out.print(orderid);
        if (action.equalsIgnoreCase("select")) {
            OrderBean ob = odb.getOrderByOrderId(Integer.parseInt(orderid));
            PrintWriter out = response.getWriter();
